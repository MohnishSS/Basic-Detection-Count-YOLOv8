...
results = model("/Users/mohnishshridhar/Desktop/ifi object count/images/busy_street.png", show=False)
...
for obj in objects_in_image:
    ...
    for i in objects:
        if i==obj:
                count+=1
    print(str(count) + " " + ("people" if obj=="person" and count>1 else (obj+"s" if count>1 else (obj))))
